...
//             <div className="w-[80%] mx-auto px-10 py-3 flex gap-5">
//                 <select className="w-100 border border-black rounded-lg py-3 outline-none" value={courseCategory} onChange={handleChange} >
//                     <option value="">Filter By Name</option>
//                     {courseCategories.map((course, key) => (
//                         <option key={key} value={course}>{course}</option>
//                     ))}
//                 </select>
//                 <select className="w-100 border border-black rounded-lg py-3 outline-none" value={courseDuration} onChange={handleDuration} >
//                     <option value="">Filter By Duration</option>
//                     {durations.map((course, key) => (
//                         <option key={key} value={course}>{course}</option>
//                     ))}
//                 </select>
//             </div>
...
//                 {data.map((item, idx) => (
//                     <div key={idx} className="flex w-full gap-10 border border-gray-200 rounded-lg p-5 bg-gray-100 hover:shadow-lg transition-shadow" >
//                         <div >
//                             <GrCertificate size={96} />
//                         </div>

//                         <div>
//                             <p className="font-sans text-2xl font-semibold">{item.courseTitle}</p>
//                             <p>{item.provider}</p>
//                             <p>{item.platform}</p>
...
//                                <a href={item?.courseLink} target="_blank"><button className="bg-gray-400 rounded-lg px-4  py-1 cursor-pointer">Start Course</button></a>
//                                 <button onClick={() => navigate(`/certificate/${item.id}/${item.courseTitle}`)}  className="bg-white border border-gray-200 px-4 py-1 rounded-lg hover:bg-gray-400 cursor-pointer">More Details</button>
//                             </div>
//                         </div>
...
//                             className={`px-4 py-2 rounded-lg text-sm font-medium ${page === i
        ...
        <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
            ...
            <div className=" border-b border-slate-200 ">
                <div className="max-w-7xl mx-auto px-6 py-8">
                    <div className=" mb-8">
                        <h1 className="text-4xl font-bold text-slate-800 mb-2">Professional Certificates</h1>
                    ...
                    <div className="bg-slate-50 rounded-2xl p-3 border border-slate-200">
                        <div className="flex items-center gap-3 mb-4">
                            {/* <BiFilterAlt className="w-5 h-5 text-slate-600" />
                            <h3 className="text-lg font-semibold text-slate-800">Filter Courses</h3> */}
                            {hasActiveFilters && (
                                <button
                ...
                {loading ? (
                    ...
                    <div className="space-y-6">
                        {data.map((item, idx) => (
                            <div 
                                key={idx} 
                                className="bg-white rounded-2xl shadow-lg border border-slate-200 hover:shadow-2xl hover:border-blue-200 transition-all duration-300 overflow-hidden group"
                            >
