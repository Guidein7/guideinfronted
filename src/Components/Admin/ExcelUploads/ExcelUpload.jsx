...
import InterviewQAUpload from './InterviewQAUpload';
        ...
        <>
            ...
            <div className="bg-[#f5faff] w-full min-h-screen">
                <div className="flex justify-between p-3">
                    ...
                    <button onClick={() => changeTab('interview')} className={`font-sans admin-tabbutton ${activeTab === 'interview' ? 'admin-tabactive' : ''}`}>InterviewQA</button>
                ...
                {activeTab === 'interview' && <InterviewQAUpload/>}
