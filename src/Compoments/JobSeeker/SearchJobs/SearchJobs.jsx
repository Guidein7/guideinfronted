...
function SearchJobs() {
    ...
    const fetchJobs = async () => {
        ...
        try {
            ...
            setJobs(response.data.reverse()); // Reverse the job list to show the last element first
    ...
    const handleSaveJob = async (jobId) => {
        ...
        try {
            ...
            // Add the saved job ID to the savedJobs set
    ...
    const handleFilterChange = (e) => {
        ...
        setCurrentPage(1); // Reset current page to 1 on filter change
    };
