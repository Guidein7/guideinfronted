...
<nav className="bg-[#f8f9fa] py-4">
    <div className="max-w-7xl mx-auto px-4 flex justify-between items-center">
        <div className="block lg:hidden">
            <button className="text-dark focus:outline-none" onClick={toggleNavbar}>
            ...
            {isOpen && (
                <div className="flex flex-col mt-2 space-y-1">
                    <button onClick={handleEarnMoneyClick} className="bg-blue-700 hover:bg-blue-700 text-white py-1 px-4 rounded focus:outline-none focus:shadow-outline">
                        Earn Money
                    </button>
                    <Link to='/register' className="bg-blue-700 hover:bg-blue-700 text-white py-1 px-4 rounded focus:outline-none focus:shadow-outline">
                        Join Now
                    </Link>
                    <Link to='/login' className="bg-blue-700 hover:bg-blue-700 text-white py-1 px-4 rounded focus:outline-none focus:shadow-outline">
                        Sign In
                    </Link>
                </div>
            )}
...
<div className="w-full">
    <img src={guideinLandingPage} alt="Landing Page" className="w-full" />
</div>
<div className="flex flex-col justify-center items-center mb-2">
    <h1 className="text-2xl font-bold my-2">To get referral</h1>
    <Link to='/subscribe' className="bg-blue-700 hover:bg-blue-700 text-white py-2 px-4 rounded focus:outline-none focus:shadow-outline">
        Subscribe Now
    </Link>
</div>
<footer className="bg-[#00145e] w-full p-4">
